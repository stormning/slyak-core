 ...
 * on top of the existing {@link org.springframework.web.servlet.config.annotation.WebMvcConfigurationSupport}.
 *
 * Unlike {@link org.springframework.web.servlet.config.annotation.WebMvcConfigurationSupport}, you SHOULD NOT import it using
 ...
 * configuration files.
 *
 * You can then instantiate your own beans and override {@link org.springframework.web.servlet.config.annotation.WebMvcConfigurationSupport} methods.
 *
 ...
 * 	<li>{@link org.springframework.web.servlet.mvc.method.annotation.RequestMappingHandlerMapping}
...
public abstract class RouterConfigurationSupport extends DelegatingWebMvcConfiguration {
    ...
    /**
     * Return a {@link org.springframework.web.servlet.mvc.method.annotation.RequestMappingHandlerMapping} ordered at 3 for mapping
